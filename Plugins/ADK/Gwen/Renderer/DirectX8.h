...
#ifndef GWEN_RENDERERS_DIRECTX8_H
#define GWEN_RENDERERS_DIRECTX8_H
...
namespace Gwen
{
	namespace Renderer
	{
		...
		class GWEN_EXPORT DirectX8 : public Gwen::Renderer::Base
		{
			public:

				DirectX8( IDirect3DDevice8* pDevice = NULL );
				~DirectX8();
